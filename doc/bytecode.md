...
TOS BPF (TBPF) is a virtual machine instruction set architecture based on eBPF. This document describes the bytecode format, instruction encoding, and version-specific features.
...
### v4
- Aligned memory mapping support (SIMD-0177)
- All v3 features are also enabled in v4
