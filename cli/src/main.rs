...
fn main() {
    let matches = App::new("Tos BPF CLI")
        .version(crate_version!())
        .author("Tos Maintainers <info@tos.network>")
        .about("CLI to test and analyze Tos BPF programs")
        .arg(
            Arg::new("assembler")
                .about("Assemble and load Tos BPF executable")
                .short('a')
                .long("asm")
                .value_name("FILE")
                .takes_value(true)
        ...
        .arg(
            Arg::new("elf")
                .about("Load ELF as Tos BPF executable")
                .short('e')
                .long("elf")
                .value_name("FILE")
                .takes_value(true)
    ...
    let memory_mapping = MemoryMapping::new(regions, config, tbpf_version).unwrap();
