...
/// Virtual address of the bytecode region (in TBPFv3)
pub const MM_BYTECODE_START: u64 = 0;
/// Virtual address of the readonly data region (also contains the bytecode until TBPFv3)
...
// Op codes
// (Following operation names are not “official”, but may be proper to tbpf; Linux kernel only
...
impl Insn {
    ...
    /// Checks if this instruction marks the start of a function (in TBPFv3)
