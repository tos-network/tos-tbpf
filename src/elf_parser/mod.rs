...
impl<'a> Elf64<'a> {
    ...
    pub fn parse_file_header(
        ...
        // SAFETY: ptr is derived from elf_bytes slice bounds and alignment is verified above
    ...
    pub fn slice_from_bytes<T: 'static>(
        ...
        // SAFETY: ptr is derived from elf_bytes slice bounds, alignment is verified above,
        // and the length calculation ensures we don't exceed the original slice bounds
        Ok(unsafe {
